...
// 3. Sukurti masyvą, kuriame pagal abėcėlę būtų surūšiuoti vardai žmonių, kurių rūbų dydžiai XS 
...
const data = [
    ...
    {id:13,first_name:"Ewell",gender:"Agender",car_model:"9-7X",car_year:2007,shirt_size:"XS"}, {id:14,first_name:"Charyl",gender:"Genderqueer",car_model:"Sidekick",car_year:1994,shirt_size:"XL"},
...
// 1
const vyruSkaicius = data.filter(zmogus => zmogus.gender === 'Male').length
console.log(vyruSkaicius)

// 2
const naujiAutomobiliai = data.filter(zmogus => zmogus.car_year > 2000).map(zmogus => zmogus.id)
console.log(naujiAutomobiliai)

// 3
const vardaiXS = data
  .filter(zmogus => zmogus.shirt_size === 'XS')
  .sort((a, b) => a.first_name.localeCompare(b.first_name))
  .map(zmogus => zmogus.first_name)
console.log(vardaiXS)

// 4
const vardaiXS1 = data
  .filter(zmogus => zmogus.shirt_size === 'XS')
  .sort((a, b) => a.first_name.localeCompare(b.first_name))
  .map(zmogus => ({ id: zmogus.id, first_name: zmogus.first_name, shirt_size: zmogus.shirt_size }))

console.log(vardaiXS1)